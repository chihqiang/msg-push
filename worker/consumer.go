...
func NewConsumer(s *svc.ServiceContext) *Consumer {
	...
	consumer.HandleFunc(queue.TaskSendMessage, func(ctx context.Context, t *asynq.Task) error {
		return handler.HandlePayload(ctx, t.Payload())
	})
	consumer.HandleFunc(queue.TaskSendBatchMessage, func(ctx context.Context, t *asynq.Task) error {
